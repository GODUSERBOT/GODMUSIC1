...
ALIVE_IMG = getenv("ALIVE_IMG", "import os
from os import getenv
from dotenv import load_dotenv
from helpers.uptools import fetch_heroku_git_url
...
BOT_TOKEN = getenv("BOT_TOKEN")
BOT_NAME = getenv("BOT_NAME", "")
BG_IMAGE = getenv("BG_IMAGE", "https://te.legra.ph/file/19d4ad2c1d80512f4a5d2.jpg")
THUMB_IMG = getenv("THUMB_IMG", "https://telegra.ph/file/2dc19950129e718fcfe4a.jpg")
AUD_IMG = getenv("AUD_IMG", "https://te.legra.ph/file/19d4ad2c1d80512f4a5d2.jpg")
QUE_IMG = getenv("QUE_IMG", "https://telegra.ph/file/c3f490ae4e81d1c258cad.jpg")
CMD_IMG = getenv("CMD_IMG", "https://te.legra.ph/file/19d4ad2c1d80512f4a5d2.jpg")
ALIVE_IMG = getenv("ALIVE_IMG", "https://te.legra.ph/file/19d4ad2c1d80512f4a5d2.jpg")
...
UPSTREAM_REPO = os.environ.get(
    "UPSTREAM_REPO", "https://github.com/GODUSERBOT/GODMUSIC1"
)
...
BOT_USERNAME = getenv("BOT_USERNAME", "")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Gods_Support")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Gods_Support")
# fill here ur owner id username without @
OWNER_NAME = getenv("OWNER_NAME", "Xmartperson")
# fill with your nickname
ALIVE_NAME = getenv("ALIVE_NAME", "Salim")
